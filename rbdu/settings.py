"""
Django settings for rbdu project.
...
SECRET_KEY = 'django-insecure-9l*_h^^=-pg78x#8c-)qv_^nb7@(a1681b!d87^=t0ut%opq@2'
...
WSGI_APPLICATION = 'rbdu.wsgi.application'
